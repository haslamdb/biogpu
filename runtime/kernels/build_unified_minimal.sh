#!/bin/bash
# Minimal build script to create the unified pipeline executable

set -e

echo "Building Minimal BioGPU Unified Pipeline..."
...
# Create a minimal unified pipeline source
cat > bio_gpu_pipeline_minimal.cpp << 'EOF'
#include <iostream>
#include <string>
#include <vector>
...
nvcc -o bio_gpu_pipeline bio_gpu_pipeline_minimal.cpp \
     -std=c++17 \
     -arch=sm_75 \
     -lcudart \
     -O2
